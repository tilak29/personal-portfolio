...
function Navbar(){
    ...
    <div id="sidebar" class="bg-[#100D15] transform fixed md:relative md:translate-x-0 transition duration-200 ease-in-out" data-dev-hint="sidebar; px-0 for frameless; px-2 for visually inset the navigation"> 
            <div className='bg-black py-5 px-6 flex flex-col justify-center items-center '>
                <Link to='/'>
                <img className='ml-4' src={logo}/>
                <p className='font-Open text-white mt-1 text-[1.5rem] font-bold'>Tilak</p>
